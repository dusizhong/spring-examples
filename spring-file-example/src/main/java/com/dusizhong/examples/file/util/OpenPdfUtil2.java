...
public class OpenPdfUtil2 {
         ...
         * @param text 单元格内容
         */
        private static Cell createDataCell(String text) throws BadElementException {
         ...
         * @param text 标题
         */
        private static Cell createTitleCell(String text) throws Exception {
            Cell cell = new Cell(new Paragraph(text, MyFontUtil.SIMSUN_TEXT));
            // 设置水平对齐方式
            cell.setHorizontalAlignment(String.valueOf(HorizontalAlignment.CENTER));
            // 设置垂直对齐方式
         ...
         * @param table 表格对象
         */
        private static void setTableStyle(Table table) throws Exception {
            // 表格在页面水平方向的对齐方式
         ...
         * @param document pdf文档对象
         */
        private static void addText(Document document) throws DocumentException {
         ...
         * @param document pdf文档对象
         */
        private static void setCover(Document document) throws DocumentException {
